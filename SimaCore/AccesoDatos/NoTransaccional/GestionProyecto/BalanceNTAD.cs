...
namespace AccesoDatos.NoTransaccional.GestionProyecto
{
    ...
    { 
        ...
        {
            string packageName = "CONSULTA.PKG_PROYECTOS.SP_COMPARVENTVSCOSTOPROYECOTR";
        ...
        public DataTable Listar_comparventvscostoproyec_o(string V_CENTRO_OPERATIVO, string V_DIVISION, string V_PERIODO, string V_PROYECTO, string UserName)
        {
            string packageName = "CONSULTA.PKG_PROYECTOS.SP_COMPARVENTVSCOSTOPROYEC_OT";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
