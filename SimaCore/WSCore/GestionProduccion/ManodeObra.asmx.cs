...
namespace WSCore.GestionProduccion
{
    ...
    //    n_opcion=6&c_mod=" + sTipoPL + "&c_tll_ini=" + cTaller + "&d_fecha=" + C_FECHA + "&c_linea=" + inivel
        ...
        {
            return controladorOt.SP_LISTA_PLANILAxTpxDvxAuxFech(sTipo, sDivision, sAreaU, sFecha, sAmbiente, UserName);
        }
        ...
        {
            return controladorOt.BuscaAprobaciónPLL(sTipoPL, cTaller, sNivel, sFecha, sAmbiente, UserName);
        }
    }
}
